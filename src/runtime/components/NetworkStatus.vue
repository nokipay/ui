...
<template>
    <div v-if="!isOnline"
        ...
        <img class="w-52 relative group-hover:scale-75 duration-200" src="@@/app/base/assets/img/logo.png" alt="Logo">

        <div class="flex space-x-4 items-center mt-10">
            <img width="50" src="@@/app/base/assets/img/cloud-offline.png" />
