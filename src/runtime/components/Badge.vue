...
const props = defineProps({
  ...
  customSize: { type: String, required: false, default: void 0 },
  color: { type: String, required: false, default: "default" },
  fontWeight: { type: String, required: false, default: "medium" },
  fontStyle: { type: String, required: false, default: "normal" },
  showEmpty: { type: Boolean, required: false, default: false }
});
const colorVariants = {
  soft: {
